...
link:LocalOpts.cpp#62[mulByPowOf2]
...
link:LocalOpts.cpp#72[mulToShift]
...
link:LocalOpts.cpp#139[divByPowOf2]
...
link:LocalOpts.cpp#156[zeroDiv]
...
link:LocalOpts.cpp#112[mulOptimization]
link:LocalOpts.cpp#164[divOptimization]
...
link:LocalOpts.cpp#195[multiInstructionOptimization]
