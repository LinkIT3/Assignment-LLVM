...
* link:LocalOpts.cpp#L58[mulByPowOf2]
...
* link:LocalOpts.cpp#L67[mulToShift]
...
* link:LocalOpts.cpp#L125[divByPowOf2]
...
* link:LocalOpts.cpp#L134[divBy1]
...
* link:LocalOpts.cpp#L140[zeroDiv]
...
* link:LocalOpts.cpp#L99[mulOptimization] e link:LocalOpts.cpp#L147[divOptimization]
...
* link:LocalOpts.cpp#L198[multiInstructionOptimization]
